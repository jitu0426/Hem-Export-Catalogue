...
def generate_pdf_html(df_sorted, customer_name, logo_b64, case_selection_map):
    ...
    # CSS
    # UPDATED CSS: FLEXBOX FOR PRODUCTS & PAGE BREAK LOGIC
    CSS_STYLES = f"""
        <!DOCTYPE html>
        ...
        * {{ box-sizing: border-box; }} 
        ...
        .category-block {{ 
            ...
            page-break-before: always; /* FORCE NEW PAGE FOR EVERY CATEGORY */
        }}
        
        /* Logic: If Category Block follows a Catalogue Header, DO NOT break page again */
        h1.catalogue-heading + .category-block {{
            page-break-before: avoid !important;
        }}

        .product-card {{ 
            flex: 0 0 23%; /* Flexbox Width */
            margin: 10px 1%; 
    ...
    for index, row in df_sorted.iterrows():
        ...
        if row['Category'] != current_category:
            ...
            # Start new Category Block (Flex container)
