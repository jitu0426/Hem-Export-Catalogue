...
def render_add_product_tab(products_df) -> None:
    ...
    if custom_items:
        st.markdown(
            f'<div style="font-size:12px;color:#a0a0c0;margin-bottom:10px;">'
        ...
        for i, item in enumerate(custom_items):
            ...
            with c_info:
                ...
                st.markdown(
                    ...
                    f"<span style='color:#a0a0c0;font-size:12px;'>"
    ...
    if overrides:
        ...
        for pid, changes in overrides.items():
            ...
            with c_info:
                st.markdown(
                    f'<span style="font-size:11px;color:#60607a;">{pid}</span>'
                    f' &nbsp;→&nbsp; {change_str}',
                    unsafe_allow_html=True,
                )
            with c_reset:
    ...
    if deleted_pids:
        ...
        for pid in deleted_pids:
            ...
            with c_info:
                st.markdown(
                    f'<span style="font-size:12px;color:#60607a;">🚫 {pid}</span>',
                    unsafe_allow_html=True,
                )
            with c_restore:
