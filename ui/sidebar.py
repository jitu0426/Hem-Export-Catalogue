    ...
    with st.sidebar:
        ...
        st.markdown(
            ...
            <div style="text-align:center;padding:20px 0 12px;">
                ...
                <div style="font-size:10px;color:#60607a;letter-spacing:3px;
        ...
        st.markdown(
            ...
            <div style="background:linear-gradient(135deg,rgba(201,168,76,0.1),rgba(201,168,76,0.03));
                ...
                <div style="font-size:11px;color:#60607a;text-transform:uppercase;
        ...
        with st.expander("View DB Stats"):
            ...
            st.markdown(
                f"""
                <div style="font-size:12px;color:#a0a0c0;line-height:2;">
                  📦 Custom products: <b style="color:#c9a84c;">{len(db.get('custom_products', []))}</b><br>
                  ✏️ Edited products: <b style="color:#c9a84c;">{len(db.get('product_overrides', {}))}</b><br>
                  🚫 Hidden products: <b style="color:#c9a84c;">{len(db.get('deleted_products', []))}</b><br>
                  🕐 Last updated: <b style="color:#c9a84c;">{db.get('last_updated','—')[:19] if db.get('last_updated') else '—'}</b>
                </div>
                """,
                unsafe_allow_html=True,
            )
        ...
        st.markdown(
            ...
            <div style="margin-top:30px;text-align:center;
                        font-size:10px;color:#3a3a5a;letter-spacing:1px;">
